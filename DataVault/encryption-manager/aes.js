...
export const generateKeyViaRPC = (provider, account) =>
  provider
    .request({
      method: "personal_sign",
      params: [
        "The website wants permission to access and manage your data vault",
        account,
      ],
    })
    .then((sig) =>
      provider
        ...
        .then((sig2) => {
          if (sig2 !== sig)
            throw new Error(
              "Sorry, your wallet does not support encryption. You cannot access your Data Vault"
            );
